...
public class JWakeWindow extends JFrame implements ActionListener, MouseListener
{
	...
	public JWakeWindow()
	{
		...
		ImageIcon addIcon = new ImageIcon(Toolkit.getDefaultToolkit().getImage("res/add.png"), "Add");
		add = new JButton(addIcon);
		add.setBorder(new EmptyBorder(4, 6, 4, 6));
		add.addActionListener(this);
		buttons.add(add);
		
		ImageIcon removeIcon = new ImageIcon(Toolkit.getDefaultToolkit().getImage("res/remove.png"), "Remove");
	...
	public void mouseClicked(MouseEvent click)
	{
		...
		{
			ImageIcon icon = new ImageIcon(Toolkit.getDefaultToolkit().getImage("res/icon-48.png"));
